...
from lesson_5.errors import IncorrectDataRecivedError
from lesson_3.common.utils import get_message, send_message
from lesson_3.common.variables import ACTION, PRESENCE, TIME, USER, ACCOUNT_NAME, RESPONSE, ERROR, DEFAULT_PORT,\
    MAX_CONNECTIONS
